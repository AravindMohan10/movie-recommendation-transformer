...
def test_mood_criteria_schema():
    from backend.app.mood_service import MoodCriteria
...
def test_fallback_mood_to_criteria():
    from backend.app.mood_service import _fallback_mood_to_criteria
    ...
    assert len(c3.keywords) >= 1


def test_mood_to_criteria_no_llm_uses_fallback():
    from backend.app.mood_service import mood_to_criteria
