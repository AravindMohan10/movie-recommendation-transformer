  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className={`fixed top-24 ${isOpen ? 'left-[260px]' : 'left-4'} z-50 w-12 h-12 rounded-full backdrop-blur-xl bg-white/5 border border-teal-500/30 flex items-center justify-center text-teal-300 transition-all duration-300 shadow-lg`}
        style={{ 
